...
export default function ConfirmTourBookingModal({
  onBack,
  onConfirm,
  loading,
  open,
        ...
        <Box sx={style}>
          <div className={Classname.container}>
            <div className={Classname.content}>
              <span className={Classname.modalTitle}>Confirm tour booking</span>
              <p className={Classname.modalDescription}>
                By clicking confirm you have booked this tour:{" "}
...
const Classname = {
  ...
  modalDescription: "text-gray-600 mb-6",
