  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center">
      <div className="card flex flex-col items-center gap-4 text-center max-w-[500px] ">
        ...
        <p>
          Your email address has been successfully verified, and your account
          activated. Continue to activate your business on Intraverse.
        </p>
        <Link
          to="/profile"
          className="btn-theme rounded-md justify-center w-full"
        >
