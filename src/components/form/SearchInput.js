  ...
  return (
    <div className={`w-full relative z-[80]`}>
      <TextField
        ...
        // }}
      />
      {exampleview ? <ExampleHandle open={exampleOpen} /> : null}
      {searchview ? <SearchHandle open={resultOpen} /> : null}
    </div>
  );
}
...
function SearchHandle({ open }) {
  ...
  return (
    <div
      className={`absolute w-full bg-secondary rounded-b-md my-2 shadow-md border ${
