    ...
    <div className={Classname.container}>
      <div className={Classname.content}>
        ...
        <div className={Classname.titleContainer}>
          {`Tour > `} <span className={Classname.titleMain}>Confirmation</span>
        </div>
        <div className={Classname.detail}>
          <div className={Classname.tourDetail}>
            ...
            <span className="font-bold text-lg mb-6">Tourist</span>
...
const Classname = {
  ...
  touristPerson:
    "text-white bg-primary1 font-bold h-14 w-36 rounded-md flex items-center justify-center gap-2",
  touristPersonIcon: "",
